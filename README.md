...
Este é um simples projeto em Java para verificar se um número é primo ou não. A aplicação recebe um número inteiro como entrada e retorna se ele é primo ou não.
